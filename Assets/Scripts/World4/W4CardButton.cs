...
public class W4CardButton : MonoBehaviour
{
    [Header("Correctness")]
    ...
    private W4CardRoundManager roundManager;
    ...
    private void Awake()
    {
        ...
        if (cardImage != null) originalSprite = cardImage.sprite;

        roundManager = GetComponentInParent<W4CardRoundManager>();
    }
    ...
    private IEnumerator HandleWrong()
    {
        ...
        Sprite prevSprite = cardImage ? cardImage.sprite : null;
        ...
        if (roundManager != null)
            roundManager.RegisterWrong();

        yield return new WaitForSeconds(wait);

        if (cardImage && prevSprite) cardImage.sprite = prevSprite;
    ...
    private IEnumerator HandleWin()
    {
        ...
        var player = FindObjectOfType<Mankibo.World4>();
